...
namespace AIRefactoring.Database
{
    public class ApplicationDbContext : DbContext
    {
        ...
        public DbSet<RefactoringCategory> RefactoringCategories { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<RefactoringCategory>(entity =>
            {
                entity.ToTable("RefactoringCategories");
            ...
            modelBuilder.Entity<RefactoringCategory>().HasData(
                new RefactoringCategory()
                {
