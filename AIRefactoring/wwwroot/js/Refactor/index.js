...
function adjustHeader()
{
    ...
    {
        document.querySelector(".refactor-header").style.display = "none";
    } else
    {
        document.querySelector(".refactor-header").style.display = "block";
    }
}
...
function addSessionToSidebar(sessionId, title)
{
    ...
    sessionItem.href = `/Refactor/Index?sessionId=${sessionId}`;
